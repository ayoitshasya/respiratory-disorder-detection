...
| TC-09 | ESP32 memory fit | Quantized model (int8) | Model size < 520KB SRAM limit | Pending | TFLite export script exists (`src/export_tflite.py`) — hardware deployment not tested |
